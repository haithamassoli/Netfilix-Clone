        ...
        <div class="frame">
            <div ng-app ng-init="checked = false">
                <form class="form-signin" action="{{ route('movies.store') }}" method="POST">
                    ...
                    <input class="form-styling" type="text" name="movie_name" placeholder="" />
                    <label for="">Movie Description</label>
                    <input class="form-styling" type="text" name="movie_description" placeholder="" />
                    <label for="">Movie Gener</label>
                    <input class="form-styling" type="text" name="movie_gener" placeholder="" />

                    <button class="btn-animate btn btn-primary">Add</button>
                </form>
            </div>
</body>
