...
<body>
    <div class="container">
        <div class="frame">
            <div>
                <form class="form-signin" action="{{ route('movies.update') }}" method="POST">
                    @csrf
                    @method("put")
                    <label for="username">Movie Name</label>
                    <input class="form-styling" type="text" name="movie_name" value="{{ $movie->movie_name }}" />
                    <label for="">Movie Description</label>
                    <input class="form-styling" type="text" name="movie_description"
                        value="{{ $movie->movie_description }}" />
                    <label for="">Movie Gener</label>
                    <input class="form-styling" type="text" name="movie_gener" value="{{ $movie->movie_gener }}" />
                    <button class="btn-animate btn btn-primary">Save</button>
                </form>
            </div>
</body>
